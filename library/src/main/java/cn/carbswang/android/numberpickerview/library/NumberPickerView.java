...
public class NumberPickerView extends View {
    ...
    // default itembg's color
    private static final int DEFAULT_CENTER_ITEM_BG_COLOR = 0XFFF5F5F5;
    ...
    // default item's height
    private static final int DEFAULT_ITEM_HEIGHT = 110;
    ...
    private int mCenterItemBgColor = DEFAULT_CENTER_ITEM_BG_COLOR;
    ...
    private Paint mPaintItemBg = new Paint();
    ...
    private int mItemHeight = DEFAULT_ITEM_HEIGHT;//设置默认item高度
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            } else if (attr == R.styleable.NumberPickerView_npv_CenterItemBgColor) {
                mCenterItemBgColor = a.getColor(attr, DEFAULT_CENTER_ITEM_BG_COLOR);
            ...
            } else if (attr == R.styleable.NumberPickerView_npv_ItemHeight) {
                mItemHeight = a.getDimensionPixelSize(attr, DEFAULT_DIVIDER_HEIGHT);
            }
        }
        a.recycle();
    }
    ...
    private void init(Context context) {
        ...
        mPaintItemBg.setColor(mCenterItemBgColor);
        mPaintItemBg.setAntiAlias(true);
        mPaintItemBg.setStyle(Paint.Style.FILL);
        mPaintItemBg.setStrokeWidth(mDividerHeight);
...
//        setMeasuredDimension(measureWidth(widthMeasureSpec),measureHeight(heightMeasureSpec));
        setMeasuredDimension(measureWidth(widthMeasureSpec),mItemHeight*mShowCount);
    }
    ...
    public void setCenterItemBgColor(int itembgColor) {
        if (mCenterItemBgColor == itembgColor) return;
        mCenterItemBgColor = itembgColor;
        mPaintItemBg.setColor(mCenterItemBgColor);
        postInvalidate();
    }
    ...
    private void drawItemBg(Canvas canvas) {
        //画背景
        canvas.drawRect(getPaddingLeft() + mDividerMarginL, dividerY0, mViewWidth - getPaddingRight() - mDividerMarginR, dividerY1, mPaintItemBg);
    ...
    private void drawLine(Canvas canvas) {
        if (mShowDivider) {
            ...
            for (int i = 1; i < mShowCount; i++) {
                canvas.drawLine(getPaddingLeft() + mDividerMarginL, i * mViewHeight / mShowCount,
                        mViewWidth - getPaddingRight() - mDividerMarginR, i * mViewHeight / mShowCount, mPaintDivider);
            }
        }
    }
